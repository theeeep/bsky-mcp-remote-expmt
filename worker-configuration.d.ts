/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b5107ee43d0861d77f3f53ed1abab400)
// Runtime types generated with workerd@1.20250604.0 2025-06-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		BLUESKY_IDENTIFIERS: string;
		BLUESKY_PASSWORD: string;
		MCP_OBJECT: DurableObjectNamespace<import("./src/index").BlueSkyMCP>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BLUESKY_IDENTIFIERS" | "BLUESKY_PASSWORD">> {}
}
